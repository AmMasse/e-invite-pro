...
const phases: Phase[] = [
  ...
  },
  {
    ...
    status: 'completed',
    items: [
      { id: '2.1', title: 'Create Excel upload interface for admins', completed: true },
      { id: '2.2', title: 'Implement Excel parsing (names, emails, phones)', completed: true },
      { id: '2.3', title: 'Add data validation and error handling', completed: true },
      { id: '2.4', title: 'Create preview for uploaded data', completed: true },
      { id: '2.5', title: 'Generate cryptographically secure unique links', completed: true },
      { id: '2.6', title: 'Create downloadable Excel with guest names + links', completed: true },
      { id: '2.7', title: 'Implement bulk guest insertion', completed: true },
      { id: '2.8', title: 'Create guest invitation page (/invite/:uniqueId)', completed: true },
      { id: '2.9', title: 'Add RSVP functionality (Yes/No/Maybe)', completed: true }
    ]
  },
  {
    id: 'phase3',
  ...
  },
  {
    ...
    status: 'completed',
    items: [
      { id: '4.1', title: 'Create itinerary builder interface', completed: true },
      { id: '4.2', title: 'Add time scheduling with date/time picker', completed: true },
      { id: '4.3', title: 'Implement location management with coordinates', completed: true },
      { id: '4.4', title: 'Create timeline view of event schedule', completed: true },
      { id: '4.5', title: 'Add interactive map integration', completed: true },
      { id: '4.6', title: 'Implement navigation links to venues', completed: true },
      { id: '4.7', title: 'Add real-time itinerary updates for guests', completed: true }
    ]
  },
  {
    id: 'phase5',
  ...
  },
  {
    ...
    status: 'in-progress',
    items: [
      { id: '7.1', title: 'Set up production Supabase environment', completed: true },
      { id: '7.2', title: 'Configure Backblaze production bucket', completed: true },
      { id: '7.3', title: 'Manage environment variables', completed: true },
